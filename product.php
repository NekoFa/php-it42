        ...
        <div class="card=body">
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th class="bg-success text-white">ราคาสนค้า</th>
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td>
                            <a href="edit_product.php?pro_id=<?php echo $row['pro_id'] ?>"class="btn btn-danger">แก้ไข</a>
                            <a href="del_product.php?pro_id=<?php echo $row['pro_id'] ?>
                            "onclick="return confirm('ยืนยันการลบ?')" class="btn btn-danger">ลบ</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
